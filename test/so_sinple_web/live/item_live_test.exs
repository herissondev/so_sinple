defmodule SoSinpleWeb.ItemLiveTest do
  use SoSinpleWeb.ConnCase

  import Phoenix.LiveViewTest
  import SoSinple.InventoryFixtures

  @create_attrs %{name: "some name", description: "some description", available: true, price: 120.5, image_url: "some image_url"}
  ...
  @invalid_attrs %{name: nil, description: nil, available: false, price: nil, image_url: nil}
